    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-7 w-full max-w-7xl mx-auto">
      ...
      >
        <div className="flex flex-col h-full">
          ...
          {/* Side by Side Layout - Centralized */}
          <div className="flex items-center justify-center gap-6 flex-1">
            <div className="transition-all duration-300 hover:translate-x-1 text-center">
              <p className={cn(
            ...
            <div className="w-px h-14 bg-border/50"></div>
      ...
      <div 
        className="glass-card p-6 border border-accent/30 transition-all duration-500 hover:scale-[1.02] hover:-translate-y-1 animate-slide-up rounded-3xl cursor-pointer active:scale-[0.98]"
        style={{
      ...
      >
        <div className="flex flex-col h-full">
          <div className="flex items-center gap-2 mb-4">
            <div className="w-10 h-10 rounded-2xl bg-accent/20 flex items-center justify-center backdrop-blur-sm transition-all duration-300 hover:bg-accent/30">
